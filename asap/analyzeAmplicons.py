...
''' % (program_shortdesc, str(__date__))
    ...
    try:
        ...
        mask_group = parser.add_argument_group("primer masking options")
        ...
        consensus_group = parser.add_argument_group("consensus calling options")
        ...
        for sample, bam, job in bam_list:
            (xml_file, job_id) = dispatcher.processBam(sample, json_filename, bam, xml_dir, job, depth, breadth, proportion, percid, mutdepth, primer_mask_file, wiggle, pmaskbam, ponlybam, base_qual, smor, wholegenome, debug, allele_min_reads, con_prop, fill_gap_char, fill_del_char)
