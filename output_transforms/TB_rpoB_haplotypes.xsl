    ...
    <xsl:template match="/analysis">
        ...
        <xsl:variable name="mutant_count_filter">
	        ...
	        <br />
	    		...
	    		<xsl:for-each select="sample[1]/assay[starts-with(@name, 'rpoB')]/amplicon//snp/@name[. != 'unknown' and . != 'position of interest']">
	    		    <th nowrap="true">
                                rpoB <xsl:value-of select="."/>
	    		    </th>
	    		</xsl:for-each>
	    		<xsl:for-each select="sample[1]/assay[starts-with(@name, 'rpoB')]/amplicon//region_of_interest//mutation/@name">
	    		    <th nowrap="true">
                                rpoB <xsl:value-of select="."/>
	    		    </th>
	    		</xsl:for-each>
                        <th>rpoB SNPs</th>
                        <th>rpoB Amino Acid Changes</th>
    			<!--this will be filled in below-->
	    		<xsl:for-each select="sample[1]/assay[starts-with(@name, 'inhA')]/amplicon//snp/@name[. != 'unknown' and . != 'position of interest']">
	    		    <th nowrap="true">
                                inhA <xsl:value-of select="."/>
	    		    </th>
	    		</xsl:for-each>
	    		<xsl:for-each select="sample[1]/assay[starts-with(@name, 'inhA')]/amplicon//region_of_interest//mutation/@name">
	    		    <th nowrap="true">
                                inhA <xsl:value-of select="."/>
	    		    </th>
	    		</xsl:for-each>
                        <th>inhA SNPs</th>
	    		<xsl:for-each select="sample[1]/assay[starts-with(@name, 'katG')]/amplicon//snp/@name[. != 'unknown' and . != 'position of interest']">
	    		    <th nowrap="true">
                                katG <xsl:value-of select="."/>
	    		    </th>
	    		</xsl:for-each>
	    		<xsl:for-each select="sample[1]/assay[starts-with(@name, 'katG')]/amplicon//region_of_interest//mutation/@name">
	    		    <th nowrap="true">
                                katG <xsl:value-of select="."/>
	    		    </th>
	    		</xsl:for-each>
                        ...
                        <xsl:for-each select="assay[starts-with(@name, 'rpoB')]/amplicon//snp[@name != 'unknown' and @name != 'position of interest']">
		            <td><xsl:choose>
	                ...
	                <xsl:for-each select="assay[starts-with(@name, 'rpoB')]/amplicon//region_of_interest//mutation">
		            <td><xsl:choose>
		            <xsl:when test="../../significance/@flag"><font color="lightgray"><em><xsl:value-of select="../../significance/@flag"/></em></font></xsl:when>
		            <xsl:when test="../significance/@flag"><font color="lightgray"><em><xsl:value-of select="../significance/@flag"/></em></font></xsl:when>
	    		...
	    		<td><xsl:for-each select="assay[starts-with(@name, 'rpoB')]/amplicon/snp">
          ...
          <!-- rpoB AA changes -->
          <td><xsl:for-each select="assay[starts-with(@name, 'rpoB')]/amplicon/region_of_interest">
              ...
              <xsl:choose>
                <xsl:when test="@aa_changes_specific_all">
                  <xsl:value-of select="@aa_changes_specific"/>
                        ...
                        <xsl:for-each select="assay[starts-with(@name, 'inhA')]/amplicon//snp[@name != 'unknown' and @name != 'position of interest']">
		            <td><xsl:choose>
		            <xsl:when test="../significance/@flag"><font color="lightgray"><em><xsl:value-of select="../significance/@flag"/></em></font></xsl:when>
		            <xsl:when test="./significance/@flag"><font color="lightgray"><em><xsl:value-of select="./significance/@flag"/></em></font></xsl:when>
		            <xsl:when test="./significance[not(@flag)]">
	                ...
	                <xsl:for-each select="assay[starts-with(@name, 'inhA')]/amplicon//region_of_interest//mutation">
		            <td><xsl:choose>
		            <xsl:when test="../../significance/@flag"><font color="lightgray"><em><xsl:value-of select="../../significance/@flag"/></em></font></xsl:when>
		            <xsl:when test="../significance/@flag"><font color="lightgray"><em><xsl:value-of select="../significance/@flag"/></em></font></xsl:when>
		            <xsl:when test="../significance[not(@flag)] and @count &gt;= $mutant_count_filter and @percent &gt;= $prop_filter">
	    		...
	    		<td><xsl:for-each select="assay[starts-with(@name, 'inhA')]/amplicon/snp">
                            <xsl:if test="snp_call/@count &gt;= $mutant_count_filter and snp_call/@percent &gt;= $prop_filter">
	    		    <xsl:value-of select="@position"/><xsl:value-of select="@reference"/>-><xsl:value-of select="snp_call"/>(<xsl:value-of select='format-number(snp_call/@percent, "##.##")'/>%)<br/>
                            </xsl:if>
	    		</xsl:for-each></td>

	                <xsl:for-each select="assay[starts-with(@name, 'katG')]/amplicon//region_of_interest//mutation">
		            <td><xsl:choose>
		            <xsl:when test="../../significance/@flag"><font color="lightgray"><em><xsl:value-of select="../../significance/@flag"/></em></font></xsl:when>
		            <xsl:when test="../significance/@flag"><font color="lightgray"><em><xsl:value-of select="../significance/@flag"/></em></font></xsl:when>
		            <xsl:when test="../significance[not(@flag)] and @count &gt;= $mutant_count_filter and @percent &gt;= $prop_filter">
	    		...
	    		<td><xsl:for-each select="assay[starts-with(@name, 'katG')]/amplicon/snp">
                            <xsl:if test="snp_call/@count &gt;= $mutant_count_filter and snp_call/@percent &gt;= $prop_filter">
	    		    <xsl:value-of select="@position"/><xsl:value-of select="@reference"/>-><xsl:value-of select="snp_call"/>(<xsl:value-of select='format-number(snp_call/@percent, "##.##")'/>%)<br/>
                            </xsl:if>
	    		</xsl:for-each></td>
        ...
        <h2>rpoB:</h2>
          <table>
            <tr>
              <th>Samples</th>
              <xsl:for-each select="sample[1]/assay[starts-with(@name, 'rpoB')]/amplicon/region_of_interest">
            ...
            <xsl:for-each select="sample">
              <tr>
                ...
                <xsl:for-each select="assay[starts-with(@name, 'rpoB')]/amplicon/region_of_interest">
                  <td>
                    Amino Acid Reference:
                    <xsl:value-of select="@aa_reference"/><br/>
                    <xsl:for-each select="amino_acid_sequence">
                      Allotype:
                      <xsl:value-of select="@underline_seq"/>,
